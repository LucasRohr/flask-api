...
# Apps
from apps.responses.responses import (
    resp_already_exists,
    resp_exception,
    resp_data_invalid,
    resp_ok
)
from apps.constants.messages import MSG_NO_DATA, \
    MSG_PASSWORD_WRONG, MSG_INVALID_DATA, MSG_RESOURCE_CREATED

# Local
from apps.models.user_package.user.user_model import User
from apps.models.user_package.schema.user_schema import UserRegistrationSchema, UserSchema
from apps.validators.password_validator import check_password_in_signup
...
class SignUp(Resource):
    ...
    def post(self, *args, **kwargs):
        ...
        if req_data is None:
            return resp_data_invalid('Users', [], msg=MSG_NO_DATA.format('dados'))
