...
def get_shortcuts_folder():
    if get_root_hkey()==winreg.HKEY_LOCAL_MACHINE:
        ...
        # non-admin install - always goes in this user_model's start menu.
        fldr = get_special_folder_path("CSIDL_PROGRAMS")
...
def fixup_dbi():
    ...
    # If the user_model didn't uninstall, they will find the .pyd which will cause
...
def install():
    ...
    # it implies a non-admin user_model, and we use sys.prefix
    for dest_dir in [get_system_dir(), sys.prefix]:
        ...
        try:
            ...
            if details.winerror==5:
                # access denied - user_model not admin - try sys.prefix dir,
    ...
    try:
        ...
        # will fail there if the user_model has no admin rights.
